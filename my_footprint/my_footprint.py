...
def my_footprint():
    return render_template("my_footprint.html")
...
def register_my_footprint(app):
    ...
    app.add_url_rule("/project/my-footprint", "my_footprint", my_footprint, strict_slashes=False)
    app.add_url_rule("/project/my-footprint-v2", "my_footprint_v2", my_footprint, strict_slashes=False)
    ...
    add_footprint_routes("/project/my-footprint", "my_footprint")
    add_footprint_routes("/project/my-footprint-v2", "my_footprint_v2")
